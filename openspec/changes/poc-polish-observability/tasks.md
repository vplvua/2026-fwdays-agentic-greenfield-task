...
- [ ] 2.3 NFR-STOR-01 demo check: redeploy (`railway up` or restart), reopen
      the ticket — photo still renders (closes the deferred S-07 demo cell)
- [ ] 2.4 Record every friction/paper-cut found during the pass as a list:
...
- [ ] 5.4 Playwright e2e: full `nx e2e web-e2e` suite green as the S-08
...
- [ ] 5.6 Launch-and-look: run the app locally, walk the slice happy path
