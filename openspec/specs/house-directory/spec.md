# house-directory Specification

## Purpose

Owner-scoped houses directory (FR-HOUSE-01/02, FR-ACCESS-01, NFR-SEC-03):
CRUD API and SPA screen for the user's personal house records (required
name/address, optional note), owner isolation with 404-style answers for
foreign or missing objects — the pattern every later slice follows — and the
"no delete while tickets exist" invariant.
