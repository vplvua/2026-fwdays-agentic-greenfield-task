...
> **Версія:** 1.0 · **Створено:** 2026-07-06 · **Оновлено:** 2026-07-07
> **Супутні документи:** [реєстр ADR](./adr/README.md) · [план агентних циклів](./agent-plan.md)
...
> Журнал `Р-/П-/В-` у POC **не ведеться** (свідоме спрощення методології): рішення під час
> розробки фіксуються одразу в ADR (інженерні) або правкою цього PRD + журнал змін §12
> (продуктові).
