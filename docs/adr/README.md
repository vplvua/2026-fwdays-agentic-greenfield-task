...
>
> **Межі:** ADR — лише інженерні рішення. Продуктові рішення фіксуються правкою
> [PRD](../PRD.md) + його журнал змін (журнал `Р-` у POC не ведеться — свідоме
> спрощення методології).
