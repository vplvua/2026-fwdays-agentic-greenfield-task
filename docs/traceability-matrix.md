...
| FR-HOUSE-02 | S-03 | [house-directory](../openspec/specs/house-directory/spec.md) «House deletion is blocked while tickets reference it» | `houses.service.spec.ts` · `api-e2e/houses.spec.ts` (видалення без заявок) · **тест відмови — S-04** (FK + сервісна перевірка, design D3) | видалення без заявок працює: локально (2026-07-08); відмова — demo у S-04 |
| FR-TICKET-01 | S-04 | — | — | — |
| FR-TICKET-02 | S-04 | — | — | — |
| FR-TICKET-03 | S-05 | — | — | — |
| FR-TICKET-04 | S-04 | — | — | — |
...
| FR-LIST-03 | S-06 | — | — | — |
| FR-LIST-04 | S-06 | — | — | — |
| FR-ACCESS-01 | S-03 (наскрізно S-04…S-07) | [house-directory](../openspec/specs/house-directory/spec.md) «Foreign or missing house answers in 404 style» | `houses.service.spec.ts` (404-парність) · `api-e2e/houses.spec.ts` (два користувачі, ідентичні тіла GET/PATCH/DELETE) | смок: користувач Б → 404 як для неіснуючого; списки строго свої (2026-07-08) |
| NFR-PERF-01 | S-06 | — | — | — |
...
| NFR-SEC-03 | S-03 (наскрізно S-04…S-07) | [house-directory](../openspec/specs/house-directory/spec.md) — власницька перевірка як безпекова межа (single-query idiom, design D2) | `api-e2e/houses.spec.ts` — ізоляція прямими HTTP-викликами, повз UI | curl чужого будинку повз UI → 404: локально (2026-07-08) |
