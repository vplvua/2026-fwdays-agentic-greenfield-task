...
- Прод: задеплоєно на Railway з TurboSMS (env: AUTH_SECRET, TURBOSMS_TOKEN,
  ...
  очима (вхід/імʼя/вихід); SMS-вхід на проді підтверджено користувачем
  (реальний SMS, 2026-07-08). Рішення ретро: Р-12 (PRD v1.3 — сутність
  session), /login-редирект — в обсязі S-03 (план v1.6)
